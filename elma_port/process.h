...
namespace elma {
    ...
    using namespace std::chrono;
     ...
     class Process {
        ...
        Process() : Process("unnamed process") {          
        }
        ...
        */
        Process(std::string name) :  
                        ...
                        _manager_ptr(NULL),
                        _num_updates(0),
                        _last_update(std::chrono::high_resolution_clock::duration::zero()),
                        _previous_update(std::chrono::high_resolution_clock::duration::zero()),
                        _period(std::chrono::high_resolution_clock::duration::zero())
        {}
        ...
        //! Getter
        //! \return The status of the process as a string
        inline string status_tostring() {
          switch (_status) {
            case UNINITIALIZED:
