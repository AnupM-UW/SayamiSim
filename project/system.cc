...
void System::update_heading(int controllerInput) {
    ...
    // will cause 5/20 deg rotation, i.e. in 1 sec, it will cause 5 deg rotation
    _heading += (double)relativeInput/(double)512 * 0.25;
...
void System::update_aoa(int controllerInput) {
    ...
    // pitch rotation of 5/20 deg, i.e. in 1 sec, the will cause pitch change of 5 deg
    _aoa += (double)relativeInput/(double)512 * 0.25;
